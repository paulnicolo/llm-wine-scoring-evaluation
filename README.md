...
## Files
- `llm_wine_scoring_evaluation.ipynb`: Full analysis notebook (assumes `wine_reviews.csv` is available locally; outputs are precomputed to avoid rerunning API calls)
